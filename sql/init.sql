...
--
-- Table structure for table `application_instruments`
--

DROP TABLE IF EXISTS `application_instruments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
-- --
-- -- Dumping data for table `application_instruments`
-- --
--
...
CREATE TABLE `injection_conditions_qc` (
  ...
  CONSTRAINT `UK_conditions` UNIQUE (`method_id`, `qctype_id`, `volume`, `instrument_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `injection_conditions_qc` VALUES (1,82,5,0.5,3),(2,82,1,0.5,3),
  ...
  -- Extra stuff imported from injection_conditions
