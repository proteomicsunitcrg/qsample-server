...
public interface RequestFileRepository extends CrudRepository<File, Long> {
    ...
    public List<RequestFile> findAllByCreationDateBetweenAndRequestCodeContainsAndFilenameContainsOrderByInsertDateDesc(Date startDate, Date endDate, String requestCode, String filename);
