    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
        <tr>
            <td align="center" style="padding: 40px 0 30px 0; background-color: #c6e3d8">
                <img id  = "headerImg"src="https://i.imgur.com/PYv63OI.png" alt="QSample logo" style="display: block; width: 325px; height: 105px;" />
        ...
        <tr>
            <td style="padding: 30px 30px 40px 30px; background-color: #fdfdfd;">
                ...
                <p><a href="${appUrl}/recovery?token=${token}">Reset password link</a></p>
                ${appUrl}/recovery?token=${token}
                <p>This link will expire in 24 hours.</p>
                <p>Best regards</p>            </td>
        </tr>
        <tr>
            <td style="padding: 30px 30px 30px 30px; font-weight: bold; background-color: #fdfdfd;">
                <p>The QSample team</p>
            </td>
        </tr>
        <tr>
